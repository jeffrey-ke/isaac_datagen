...
**Status 2026-07-11: variant A DELETED, -1inst reseeded — superseded in part by
[`store-snacks-finetune-renders.md`](store-snacks-finetune-renders.md).** The solo fine-tune pool
