# ingest30 Plan-B smoke: throwaway sizes (larger than smokeA), real mechanisms. NOT an
# experiment recipe. Manual walk of the `meta init` sequence (Plan C automates this).
...
root = Path("/data/user/jeffk/ingest30/smokeB")
...
sa = ScriptArgs(
    ...
    base_num_dirs=1, base_num_targets=2, base_num_frames=10, base_replicas=2,
    # 2 targets x 10 frames = 20 obs -> ~2 val frames at val_ratio 0.1
    pool_frames=20, test_store_num_frames=2,
